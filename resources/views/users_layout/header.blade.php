			...
			<nav class="navbar navbar-expand-lg">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
										...
										<div class="col-md-3 col-width">
											<div class="dropdown_content">
												...
												<ul>
													...
													<li> <a href=""><img src="{{ asset('assets/img/doc_Icon.svg') }}"
																class="header_img"></img>Item2</a></li>
													<li> <a href=""><img src="{{ asset('assets/img/doc_Icon.svg') }}"
																class="header_img"></img>Item3</a></li>
													<li> <a href=""><img src="{{ asset('assets/img/doc_Icon.svg') }}"
																class="header_img"></img>Item4</a></li>
													<li> <a href=""><img src="{{ asset('assets/img/doc_Icon.svg') }}"
																class="header_img"></img>Item5</a></li>
												</ul>
											</div>
										</div>
										<div class="col-md-3 col-width">
					...
					<div class="right_menu">
						<ul>
							<li>
								<a href="{{ url('/asi-funciona') }}">Así funciona </a>
							</li>
							<li>
								<a href="{{ url('/centro-de-ayuda') }}">Ayuda</a>
							</li>
						</ul>
					</div>
				</div>
